...
The baseline selects from candidates generated by the engine's own blocking step, not from a cold search over all orders. The comparison isolates the decision stage; it is not a test of end-to-end LLM retrieval.
